...
## Curses Module:
- Provides an interface to the curses library.  
- **Curses Library:**  Provides a set of functions that enables to manipulate a terminal's display regardless of the terminal type. 
``` python
import curses
